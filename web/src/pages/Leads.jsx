              ...
              <tbody className="divide-y divide-slate-50">
                {filteredLeads.map((lead) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-7">
                      <span className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-wider border ${lead.stage === 'WON' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' :
